      ...
      <tr>
        <td>
          <table align='center' border='0' cellpadding='0' cellspacing='0' width='600' style='border: none; border-collapse: collapse;'>
            <tr>
              <td style='padding: 10px 0; border: none; vertical-align: middle;'><strong style='font-size: 16px'><?php echo empty($config->company->name) ? $lang->ranzhi : $config->company->name;?></strong></td>
            </tr>
          </table>
